"""
dual_arm_real_v2.launch.py
Uses official ur_description URDF (correct kinematics from real robot)
Single controller_manager for both arms. So, no namespace conflict
"""
import os
