...
#include "easy_handeye2_msgs/msg/detail/sample_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const easy_handeye2_msgs::msg::HandeyeCalibrationParameters &,
...
{
bool cdr_serialize(
  const easy_handeye2_msgs::msg::Sample &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  easy_handeye2_msgs::msg::Sample &);
size_t get_serialized_size(
  const easy_handeye2_msgs::msg::Sample &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const easy_handeye2_msgs::msg::SampleList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  easy_handeye2_msgs::msg::SampleList & ros_message)
{
  // Member: parameters
  ...
  size_t current_alignment)
{
  ...
  // Member: parameters
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_HandeyeCalibrationParameters(
  ...
  // Member: samples
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Sample(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = easy_handeye2_msgs::msg::SampleList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::msg::SampleList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<easy_handeye2_msgs::msg::SampleList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SampleList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::msg::SampleList *>(
...
static size_t _SampleList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SampleList(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SampleList__callbacks = {
...
static rosidl_message_type_support_t _SampleList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SampleList__callbacks,
...
{
  return &easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::_SampleList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, easy_handeye2_msgs, msg, SampleList)() {
  return &easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::_SampleList__handle;
}
