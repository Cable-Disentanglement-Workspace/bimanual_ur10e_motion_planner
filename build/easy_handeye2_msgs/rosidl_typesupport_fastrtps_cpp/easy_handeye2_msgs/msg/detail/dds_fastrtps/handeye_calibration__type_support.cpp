...
#include "easy_handeye2_msgs/msg/detail/handeye_calibration__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const easy_handeye2_msgs::msg::HandeyeCalibration & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  easy_handeye2_msgs::msg::HandeyeCalibration & ros_message)
{
  // Member: parameters
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = easy_handeye2_msgs::msg::HandeyeCalibration;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::msg::HandeyeCalibration *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<easy_handeye2_msgs::msg::HandeyeCalibration *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HandeyeCalibration__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::msg::HandeyeCalibration *>(
...
static size_t _HandeyeCalibration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HandeyeCalibration(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HandeyeCalibration__callbacks = {
...
static rosidl_message_type_support_t _HandeyeCalibration__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HandeyeCalibration__callbacks,
...
{
  return &easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::_HandeyeCalibration__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, easy_handeye2_msgs, msg, HandeyeCalibration)() {
  return &easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::_HandeyeCalibration__handle;
}
