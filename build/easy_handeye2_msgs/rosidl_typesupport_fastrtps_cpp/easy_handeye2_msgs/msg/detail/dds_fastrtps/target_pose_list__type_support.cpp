...
#include "easy_handeye2_msgs/msg/detail/target_pose_list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = easy_handeye2_msgs::msg::TargetPoseList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::msg::TargetPoseList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<easy_handeye2_msgs::msg::TargetPoseList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TargetPoseList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::msg::TargetPoseList *>(
...
static size_t _TargetPoseList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TargetPoseList(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TargetPoseList__callbacks = {
...
static rosidl_message_type_support_t _TargetPoseList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetPoseList__callbacks,
...
get_message_type_support_handle<easy_handeye2_msgs::msg::TargetPoseList>()
{
  return &easy_handeye2_msgs::msg::typesupport_fastrtps_cpp::_TargetPoseList__handle;
}
