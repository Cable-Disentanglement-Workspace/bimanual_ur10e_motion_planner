...
#include "easy_handeye2_msgs/srv/detail/execute_plan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = easy_handeye2_msgs::srv::ExecutePlan_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::srv::ExecutePlan_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<easy_handeye2_msgs::srv::ExecutePlan_Request *>(
    untyped_ros_message);
...
{
  return &easy_handeye2_msgs::srv::typesupport_fastrtps_cpp::_ExecutePlan_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = easy_handeye2_msgs::srv::ExecutePlan_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const easy_handeye2_msgs::srv::ExecutePlan_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<easy_handeye2_msgs::srv::ExecutePlan_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &easy_handeye2_msgs::srv::typesupport_fastrtps_cpp::_ExecutePlan_Response__handle;
}
...
{
  return &easy_handeye2_msgs::srv::typesupport_fastrtps_cpp::_ExecutePlan__handle;
}
